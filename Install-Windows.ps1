...
foreach ($name in @('dist\zh\AppleMusic样式标题.setting','dist\en\AppleMusic样式标题.setting','workflow-plugin\scripts\install.ps1')) {
...
Write-Host '安装完成，请完全重启 DaVinci Resolve；旧时间线中的标题不会自动替换，请重新拖入 AppleMusic样式标题。'
